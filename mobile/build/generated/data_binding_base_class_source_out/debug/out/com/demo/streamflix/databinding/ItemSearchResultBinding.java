...
public final class ItemSearchResultBinding implements ViewBinding {
  ...
  private ItemSearchResultBinding(@NonNull CardView rootView, @NonNull ImageView ivChannelLogo,
  ...
  public static ItemSearchResultBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemSearchResultBinding((CardView) rootView, ivChannelLogo, tvChannelName);
    }
