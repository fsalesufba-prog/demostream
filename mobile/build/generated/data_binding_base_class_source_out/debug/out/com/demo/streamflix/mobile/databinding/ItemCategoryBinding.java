...
public final class ItemCategoryBinding implements ViewBinding {
  ...
  private ItemCategoryBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView ivCategoryIcon,
  ...
  public static ItemCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCategoryBinding((ConstraintLayout) rootView, ivCategoryIcon, tvCategoryName);
    }
